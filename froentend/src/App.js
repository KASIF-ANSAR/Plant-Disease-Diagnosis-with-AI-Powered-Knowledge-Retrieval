...
function App() {
  ...
  const handleQuestion = async () => {
    ...
    try {
      ...
      setChatMessages(prev => [...prev, { role: "ai", text: "RAG request failed." }]);
    }
  ...
  return (
    <div className="app-container">
      ...
      {/* TITLE */}
      <h2 className="app-title">Plant Disease Diagnosis Assistant</h2>

      {/* LOGIN / REGISTER: centered wrapper */}
      {!user && (
        <div className="login-wrapper">
          <div className="login-box">
            <h3 className="login-title">{isRegistering ? "Create an Account" : "Welcome Back"}</h3>
            ...
            <button onClick={isRegistering ? handleRegister : handleLogin} className="btn primary">
              {isRegistering ? "Register" : "Login"}
            </button>

            <p className="switch-form" onClick={() => setIsRegistering(!isRegistering)}>
        ...
        <div className="main-layout">
          ...
          <div className="prediction-panel">
            ...
            <div className="pred-box">
              <strong>Disease:</strong> {prediction.label}<br />
          ...
          <div className="chat-panel">
            ...
            {/* INPUT BAR AT TOP */}
            <div className="chat-input-bar top">
              <input
                type="text"
                placeholder="Ask something about this disease..."
                value={userQuestion}
                onChange={(e) => setUserQuestion(e.target.value)}
                onKeyDown={(e) => e.key === "Enter" && handleQuestion()}
              />

              <button className="send-btn" onClick={handleQuestion}>➤</button>
            </div>
      ...
      {/* UPLOAD SECTION (when logged in but no prediction yet) */}
      {user && !prediction && (
        <div className="upload-box">
          ...
          {previewUrl && <img src={previewUrl} alt="Preview" className="uploaded-image" />}
        </div>
      )}
